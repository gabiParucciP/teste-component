...
import { TimePrecision, TimezoneUtils } from "@blueprintjs/datetime";
/**
...
export function onChangeAdapter(handler) {
    ...
    var tz = TimezoneUtils.getCurrentTimezone();
    return function (newDate, isUserChange) { var _a; return handler((_a = TimezoneUtils.getDateObjectFromIsoString(newDate, tz)) !== null && _a !== void 0 ? _a : null, isUserChange); };
}
/**
...
function convertDateToDateString(date, timePrecision) {
    var tz = TimezoneUtils.getCurrentTimezone();
    var inferredTimePrecision = date.getMilliseconds() !== 0
