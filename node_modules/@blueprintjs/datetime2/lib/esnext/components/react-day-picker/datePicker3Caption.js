...
export const DatePicker3Caption = props => {
    ...
    const prevButton = (React.createElement(Button, { "aria-label": labels.labelPrevious(previousMonth, { locale }), className: classNames(CaptionClasses.DATEPICKER3_NAV_BUTTON, CaptionClasses.DATEPICKER3_NAV_BUTTON_PREVIOUS), disabled: !previousMonth, icon: React.createElement(ChevronLeft, null), minimal: true, onClick: handlePreviousClick }));
    const nextButton = (React.createElement(Button, { "aria-label": labels.labelNext(nextMonth, { locale }), className: classNames(CaptionClasses.DATEPICKER3_NAV_BUTTON, CaptionClasses.DATEPICKER3_NAV_BUTTON_NEXT), disabled: !nextMonth, icon: React.createElement(ChevronRight, null), minimal: true, onClick: handleNextClick }));
