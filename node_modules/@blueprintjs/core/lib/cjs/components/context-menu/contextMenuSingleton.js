...
function showContextMenu(props, options) {
    ...
    var _a = options.container, container = _a === void 0 ? document.body : _a, 
    ...
    // TODO(React 18): Replace deprecated ReactDOM methods. See: https://github.com/palantir/blueprint/issues/7165
    // eslint-disable-next-line @typescript-eslint/no-deprecated
    domRenderer(React.createElement(overlaysProvider_1.OverlaysProvider, null,
        React.createElement(UncontrolledContextMenuPopover, tslib_1.__assign({}, props))), contextMenuElement);
}
