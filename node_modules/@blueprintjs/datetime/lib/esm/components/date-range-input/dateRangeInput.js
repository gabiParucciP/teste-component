...
import { AbstractPureComponent, Boundary, Classes as CoreClasses, DISPLAYNAME_PREFIX, InputGroup, Intent, Popover, refHandler, setRef, Utils, } from "@blueprintjs/core";
...
var DateRangeInput = /** @class */ (function (_super) {
    ...
    function DateRangeInput(props) {
        ...
        _this.handleInputFocus = function (_e, boundary) {
            ...
            // in that case.
            var inputString = getFormattedDateString(isValueControlled ? values.controlledValue : values.selectedValue, _this.props, true);
