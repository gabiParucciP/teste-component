...
import { combineModifiers, getDefaultMaxDate, getDefaultMinDate, HOVERED_RANGE_MODIFIER, SELECTED_RANGE_MODIFIER, } from "../date-picker/datePickerCore";
...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    function DateRangePicker(props) {
        ...
        _this.modifiers = (_a = {},
            ...
            _a["".concat(SELECTED_RANGE_MODIFIER, "-start")] = function (day) { return DateUtils.isSameDay(_this.state.value[0], day); },
            _a["".concat(SELECTED_RANGE_MODIFIER, "-end")] = function (day) { return DateUtils.isSameDay(_this.state.value[1], day); },
        ...
        var initialMonthEqualsMinMonth = DateUtils.isSameMonth(initialMonth, props.minDate);
        var initalMonthEqualsMaxMonth = DateUtils.isSameMonth(initialMonth, props.maxDate);
        ...
        var rightView = !props.contiguousCalendarMonths && rightDate != null && !DateUtils.isSameMonth(initialMonth, rightDate)
    ...
    DateRangePicker.prototype.render = function () {
        ...
        var isShowingOneMonth = singleMonthOnly || DateUtils.isSameMonth(this.props.minDate, this.props.maxDate);
        var classes = classNames(Classes.DATEPICKER, Classes.DATERANGEPICKER, className, (_a = {},
            ...
            _a[Classes.DATERANGEPICKER_SINGLE_MONTH] = isShowingOneMonth,
            _a));
    ...
    DateRangePicker.prototype.maybeRenderTimePickers = function (isShowingOneMonth) {
        ...
        if (isShowingOneMonth) {
            ...
            return (React.createElement("div", { className: Classes.DATERANGEPICKER_TIMEPICKERS },
