...
var DatePicker = /** @class */ (function (_super) {
    ...
    function DatePicker(props) {
        ...
        _this.handleDayClick = function (day, modifiers, e) {
            ...
            var newValue = _this.props.canClearSelection && modifiers.selected ? null : common_1.DateUtils.getDateTime(day, _this.state.value);
        ...
        _this.handleShortcutClick = function (shortcut, selectedShortcutIndex) {
            ...
            var newValue = includeTime ? newDate : common_1.DateUtils.getDateTime(newDate, _this.state.value);
        ...
        _this.handleTimeChange = function (time) {
            ...
            var newValue = common_1.DateUtils.getDateTime(value != null ? value : new Date(), time);
            _this.updateValue(newValue, true);
        };
    ...
    DatePicker.prototype.maybeRenderTimePicker = function () {
        ...
        var applyMin = common_1.DateUtils.isSameDay(this.state.value, minDate);
        var applyMax = common_1.DateUtils.isSameDay(this.state.value, maxDate);
    ...
    DatePicker.prototype.computeValidDateInSpecifiedMonthYear = function (displayYear, displayMonth) {
        ...
        var value = common_1.DateUtils.getDateTime(new Date(displayYear, displayMonth, displayDate, 12), this.state.value);
