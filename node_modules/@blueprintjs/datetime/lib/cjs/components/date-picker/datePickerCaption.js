...
var DatePickerCaption = /** @class */ (function (_super) {
    ...
    DatePickerCaption.prototype.render = function () {
        ...
        var monthSelect = (React.createElement(core_1.HTMLSelect, { "aria-label": "Month", iconProps: { style: { right: this.state.monthRightOffset } }, className: common_1.Classes.DATEPICKER_MONTH_SELECT, key: "month", minimal: true, onChange: this.handleMonthSelectChange, value: displayMonth, options: monthOptionElements }));
        var yearSelect = (React.createElement(core_1.HTMLSelect, { "aria-label": "Year", className: common_1.Classes.DATEPICKER_YEAR_SELECT, key: "year", minimal: true, onChange: this.handleYearSelectChange, value: displayYear, options: years }));
        ...
        return (React.createElement("div", { className: this.props.classNames.caption },
            React.createElement("div", { className: common_1.Classes.DATEPICKER_CAPTION, ref: function (ref) { return (_this.containerElement = ref); } }, orderedSelects),
    ...
    DatePickerCaption.prototype.positionArrows = function () {
        ...
        var monthTextWidth = (0, utils_1.measureTextWidth)(this.displayedMonthText, common_1.Classes.DATEPICKER_CAPTION_MEASURE, this.containerElement);
        var monthSelectWidth = this.containerElement == null ? 0 : this.containerElement.firstElementChild.clientWidth;
        var rightOffset = Math.max(2, monthSelectWidth - monthTextWidth - icons_1.IconSize.STANDARD - 2);
