...
var dateFormatProps_1 = require("../../common/dateFormatProps");
var dateUtils_1 = require("../../common/dateUtils");
var Errors = tslib_1.__importStar(require("../../common/errors"));
var datePickerUtils_1 = require("../date-picker/datePickerUtils");
var dateRangePicker_1 = require("../date-range-picker/dateRangePicker");
/**
...
var DateRangeInput = /** @class */ (function (_super) {
    ...
    function DateRangeInput(props) {
        ...
        _this.handleInputFocus = function (_e, boundary) {
            ...
            // in that case.
            var inputString = (0, dateFormatProps_1.getFormattedDateString)(isValueControlled ? values.controlledValue : values.selectedValue, _this.props, true);
        ...
        _this.handleInputBlur = function (_e, boundary) {
            ...
            if (_this.isInputEmpty(values.inputString)) {
                if (isValueControlled) {
                    nextState = tslib_1.__assign(tslib_1.__assign({}, nextState), (_b = {}, _b[keys.inputString] = (0, dateFormatProps_1.getFormattedDateString)(values.controlledValue, _this.props), _b));
                }
                else {
        ...
        _this.getInputDisplayString = function (boundary) {
            ...
            if (hoverString != null) {
                ...
                return (0, dateFormatProps_1.getFormattedDateString)(selectedValue, _this.props);
            }
        };
    ...
    DateRangeInput.prototype.render = function () {
        ...
        var _a = this.props, _b = _a.popoverProps, popoverProps = _b === void 0 ? {} : _b, popoverRef = _a.popoverRef;
    ...
    DateRangeInput.prototype.getFormattedMinMaxDateString = function (props, propName) {
        ...
        return (0, dateFormatProps_1.getFormattedDateString)(date === undefined ? defaultDate : date, this.props);
    };
