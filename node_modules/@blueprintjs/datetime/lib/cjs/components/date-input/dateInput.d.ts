...
import { type InputGroupProps, type Props } from "@blueprintjs/core";
import { type DateFormatProps, type DatePickerBaseProps } from "../../common";
...
export declare const DATEINPUT_DEFAULT_PROPS: {
    closeOnSelection: boolean;
    disabled: boolean;
