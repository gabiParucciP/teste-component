...
var TimePicker = /** @class */ (function (_super) {
    ...
    function TimePicker(props) {
        ...
        _this.getInputKeyDownHandler = function (unit) { return function (e) {
            var _a, _b;
            handleKeyEvent(e, {
                ArrowDown: function () { return _this.decrementTime(unit); },
                ArrowUp: function () { return _this.incrementTime(unit); },
                Enter: function () {
                    e.currentTarget.blur();
                },
            });
            (_b = (_a = _this.props).onKeyDown) === null || _b === void 0 ? void 0 : _b.call(_a, e, unit);
        }; };
        ...
        _this.handleAmPmChange = function (e) {
            ...
            if (isNextPm !== _this.state.isPm) {
                var hour_1 = common_1.DateUtils.convert24HourMeridiem(_this.state.value.getHours(), isNextPm);
    ...
    TimePicker.prototype.render = function () {
        var _a;
        var shouldRenderMilliseconds = this.props.precision === common_1.TimePrecision.MILLISECOND;
        var shouldRenderSeconds = shouldRenderMilliseconds || this.props.precision === common_1.TimePrecision.SECOND;
        var hourUnit = this.props.useAmPm ? timeUnit_1.TimeUnit.HOUR_12 : timeUnit_1.TimeUnit.HOUR_24;
        var classes = (0, classnames_1.default)(common_1.Classes.TIMEPICKER, this.props.className, (_a = {},
    ...
    TimePicker.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (didBoundsChange) {
            value = common_1.DateUtils.getTimeInRange(this.state.value, this.props.minTime, this.props.maxTime);
        }
        if (this.props.value != null && !common_1.DateUtils.isSameTime(this.props.value, prevProps.value)) {
    ...
    TimePicker.prototype.maybeRenderArrowButton = function (isDirectionUp, timeUnit) {
        ...
        var classes = (0, classnames_1.default)(common_1.Classes.TIMEPICKER_ARROW_BUTTON, (0, timeUnit_1.getTimeUnitClassName)(timeUnit));
    ...
    TimePicker.prototype.renderDivider = function (text) {
        if (text === void 0) { text = ":"; }
        return React.createElement("span", { className: common_1.Classes.TIMEPICKER_DIVIDER_TEXT }, text);
    };
    ...
    TimePicker.prototype.maybeRenderAmPm = function () {
        ...
        return (React.createElement(core_1.HTMLSelect, { className: common_1.Classes.TIMEPICKER_AMPM_SELECT, disabled: this.props.disabled, onChange: this.handleAmPmChange, value: this.state.isPm ? "pm" : "am" },
    ...
    TimePicker.prototype.getFullStateFromValue = function (value, useAmPm) {
        var timeInRange = common_1.DateUtils.getTimeInRange(value, this.props.minTime, this.props.maxTime);
    ...
    TimePicker.prototype.updateTime = function (time, unit) {
        var newValue = common_1.DateUtils.clone(this.state.value);
        if ((0, timeUnit_1.isTimeUnitValid)(unit, time)) {
            (0, timeUnit_1.setTimeUnit)(unit, time, newValue, this.state.isPm);
            if (common_1.DateUtils.isTimeInRange(newValue, this.props.minTime, this.props.maxTime)) {
    ...
    TimePicker.prototype.updateState = function (state) {
        var _a, _b;
        var newState = state;
        var hasNewValue = newState.value != null && !common_1.DateUtils.isSameTime(newState.value, this.state.value);
        if (this.props.value == null) {
            ...
            if (hasNewValue) {
                ...
                this.setState(tslib_1.__assign(tslib_1.__assign({}, newState), { value: common_1.DateUtils.clone(this.state.value) }));
            }
        }
        if (hasNewValue) {
