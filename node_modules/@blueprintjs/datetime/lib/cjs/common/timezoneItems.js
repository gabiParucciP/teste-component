...
var timezoneOffsetUtils_1 = require("./timezoneOffsetUtils");
...
exports.TIMEZONE_ITEMS = timezonesWithoutOffset.map(function (tz) { return (0, timezoneOffsetUtils_1.lookupTimezoneOffset)(tz); });
/** Minimal list of timezones */
exports.MINIMAL_TIMEZONE_ITEMS = minimalTimezonesWithoutOffset.map(function (tz) { return (0, timezoneOffsetUtils_1.lookupTimezoneOffset)(tz); });
