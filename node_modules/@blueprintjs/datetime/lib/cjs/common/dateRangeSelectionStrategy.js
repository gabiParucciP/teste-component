...
var DateRangeSelectionStrategy = /** @class */ (function () {
    ...
    DateRangeSelectionStrategy.getNextStateForBoundary = function (currentRange, day, allowSingleDayRange, boundary) {
        ...
        if (boundaryDate == null && otherBoundaryDate == null) {
            ...
            var nextBoundaryDate = (0, dateUtils_1.isSameDay)(boundaryDate, day) ? null : day;
            nextBoundary = boundary;
            ...
            if ((0, dateUtils_1.isSameDay)(boundaryDate, day)) {
                var isSingleDayRangeSelected = (0, dateUtils_1.isSameDay)(boundaryDate, otherBoundaryDate);
            ...
            else if ((0, dateUtils_1.isSameDay)(day, otherBoundaryDate)) {
    ...
    DateRangeSelectionStrategy.getDefaultNextState = function (selectedRange, day, allowSingleDayRange) {
        ...
        var nextDateRange;
        var nextBoundary = core_1.Boundary.START;
        if (start == null && end == null) {
            ...
            var isStart = (0, dateUtils_1.isSameDay)(start, day);
            var isEnd = (0, dateUtils_1.isSameDay)(end, day);
            if (isStart && isEnd) {
