...
function lookupTimezoneOffset(tz, date) {
    var offsetInMs = (0, date_fns_tz_1.getTimezoneOffset)(tz.ianaCode, date);
    if (isNaN(offsetInMs)) {
    ...
    return tslib_1.__assign(tslib_1.__assign({}, tz), { offset: "".concat(isPositiveOffset ? "+" : "-").concat(offsetHours, ":").concat(offsetMinutes) });
}
