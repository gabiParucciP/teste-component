...
var StickyTableHeader = /** @class */ (function () {
    ...
    StickyTableHeader.prototype.setupClickEventMirroring = function () {
        ...
        this.clickListener = function (event) {
            ...
            hiddenTargets.forEach(function (t) { return t.style.removeProperty("visibility"); });
            scrollParents.forEach(function (p) { return p.scrollTo({ behavior: "instant", top: p._save_scroll }); });
        };
